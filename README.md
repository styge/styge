...
| :---------------------- | :---------------------- | :---------------------- |
| [Получение полной информации о товарах на сайте https://www.detmir.ru/ в категориях Бомберы и Утепленные брюки](https://github.com/styge/detmir_parser) | Используя фреймворк Scrapy, написать код программы для получения информации о товарах интернет-магазина из выбранной категории, информацию представлять в виде списка словарей (один товар - один словарь) и сохранить в файл с расширением .json | ![](https://img.shields.io/badge/-Python-000000?style=for-the-badge&logo=python) ![](https://img.shields.io/badge/-Scrapy-000000?style=for-the-badge) |
| [Получение полной информации о товарах на сайте https://www.lifepharmacy.com/ в категории Shampoo](https://github.com/styge/lifepharmacy_parser) | Используя фреймворк Scrapy, написать код программы для получения информации о товарах интернет-магазина из выбранной категории, информацию представлять в виде списка словарей (один товар - один словарь) и сохранить в файл с расширением .json | ![](https://img.shields.io/badge/-Python-000000?style=for-the-badge&logo=python) ![](https://img.shields.io/badge/-Scrapy-000000?style=for-the-badge) |
| [Получение информации о товарах на сайте https://lekopttorg.ru/](https://github.com/styge/lekopttorg_parser/tree/main) | Используя фреймворк Scrapy, написать код программы для получения информации о товарах интернет-магазина из выбранной категории, информацию представлять в виде списка словарей (один товар - один словарь) и сохранить в файл с расширением .json | ![](https://img.shields.io/badge/-Python-000000?style=for-the-badge&logo=python) ![](https://img.shields.io/badge/-Scrapy-000000?style=for-the-badge) |
